...
> **講師向けメモ**  
> 完成済みの構成図や Bicep は、講師用のサンプルとしてローカルに保持します。参加者には完成済みサンプルを見せず、Azure Resources 拡張機能や Azure Portal で確認した実リソースから Copilot と一緒に作ってもらいます。
...
| 0:20 - 0:45 | Azure Resources で既存インフラを確認し、Mermaid 構成図を作成 |
...
Azure への実デプロイは行いません。Azure サブスクリプションや権限がない場合は、講師が画面共有する Azure Resources の情報をもとに進めます。
...
- Azure Resources 拡張機能で確認した情報をもとに Mermaid 構成図を作れる
